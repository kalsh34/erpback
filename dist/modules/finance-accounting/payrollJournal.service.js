...
exports.PayrollJournalService = void 0;
...
class PayrollJournalService {
     ...
     */
    static async postGuardPayroll(record, periodLabel, userId, auditCtx) {
        ...
        const entry = await journal_service_1.JournalService.createEntry({
            ...
            lines,
            payrollPeriodId: record.payrollPeriodId?._id?.toString() || record.payrollPeriodId?.toString(),
            userId,
            ip: auditCtx?.ip,
            ua: auditCtx?.ua,
        });
        EventBus_1.eventBus.emit('finance.journal.created', { entryId: entry._id, type: 'PAYROLL', module: 'GUARD' });
        return entry;
    }
    static async postStaffPayroll(record, periodLabel, userId, auditCtx) {
        ...
        EventBus_1.eventBus.emit('finance.journal.created', { entryId: entry._id, type: 'PAYROLL', module: 'STAFF' });
        return entry;
    }
}
exports.PayrollJournalService = PayrollJournalService;
//# sourceMappingURL=payrollJournal.service.js.map